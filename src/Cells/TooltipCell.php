...
/**
 * Renders a Bootstrap 5 tooltip trigger through a CodeIgniter 4 Cell.
 */
final class TooltipCell extends Cell
{
    protected string $view = 'tooltip';
    ...
    /**
     * Prepares the tooltip trigger payload passed to the view.
     */
